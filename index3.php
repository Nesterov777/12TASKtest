<?php
//Практичесское задание №12. В задании могут быть допущены ошибки. Прекрасно понимаю, что данное задание не будет принято, поэтому отправляю ДЗ с целью разбора моих ошибок
